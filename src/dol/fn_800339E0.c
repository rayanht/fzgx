...
void fn_800339E0(GXAttr attr, void *base_ptr, u8 stride) {
    GXAttr cpAttr;
    u32 phyAddr;
    if (attr == GX_VA_NBT) {
        attr = GX_VA_NRM;
    ...
    do {
        long regAddr;
        GXFIFO.u8 = (u8)(8);
        GXFIFO.u8 = (u8)(cpAttr | GX_BP_REG_SETMODE0_TEX4);
        GXFIFO.u32 = (u32)(phyAddr);
        regAddr = cpAttr - 12;
    ...
    do {
        long regAddr;
        GXFIFO.u8 = (u8)(8);
        GXFIFO.u8 = (u8)(cpAttr | GX_BP_REG_SETIMAGE2_TEX4);
        GXFIFO.u32 = (u32)(stride);
        regAddr = cpAttr - 12;
        if (regAddr >= 0 && regAddr < 4) {
