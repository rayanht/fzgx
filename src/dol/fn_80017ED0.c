...
void fn_80017ED0(u32 intType) {
    ...
    lbl_801A68F4 = 0;
    if ((CurrCommand_801A68DC == 4) || (CurrCommand_801A68DC == 5) ||
        (CurrCommand_801A68DC == 13) || (CurrCommand_801A68DC == 15)) {
        ResetRequired_801A68F8 = 1;
    }
    if (!CheckCancel(2)) {
        executing_801A68C0->state = 11;
        fn_800186C0();
    }
}
