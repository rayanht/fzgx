...
extern double fn_8008809C(double, int *);

extern double fn_80088128(double, int);

extern double fn_800882EC(double, double *);
...
void fn_8007C55C(decimal *d, f64 x) {
