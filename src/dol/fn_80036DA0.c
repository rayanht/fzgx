...
void fn_80036DA0(GXIndTexStageID stage, GXTexCoordID coord, GXTexMapID map) {
    switch (stage) {
    case GX_INDTEXSTAGE0:
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (29) - (3) + 1))) |
                     ((int)(map) << (31 - (29) - (3) + 1));
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (26) - (3) + 1))) |
                     ((int)(coord) << (31 - (26) - (3) + 1));
        break;
    case GX_INDTEXSTAGE1:
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (23) - (3) + 1))) |
                     ((int)(map) << (31 - (23) - (3) + 1));
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (20) - (3) + 1))) |
                     ((int)(coord) << (31 - (20) - (3) + 1));
        break;
    case GX_INDTEXSTAGE2:
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (17) - (3) + 1))) |
                     ((int)(map) << (31 - (17) - (3) + 1));
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (14) - (3) + 1))) |
                     ((int)(coord) << (31 - (14) - (3) + 1));
        break;
    case GX_INDTEXSTAGE3:
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (11) - (3) + 1))) |
                     ((int)(map) << (31 - (11) - (3) + 1));
        (gx->iref) = (gx->iref & ~(((1 << (3)) - 1) << (31 - (8) - (3) + 1))) |
                     ((int)(coord) << (31 - (8) - (3) + 1));
        break;
    }
    GXFIFO.u8 = 0x61;
