...
void fn_80037354(GXTevStageID stage, GXTevKColorSel sel) {
    u32 *reg;
    reg = &gx->tevKsel[stage >> 1];
    if (stage & 1) {
        (*reg) = (*reg & ~(((1 << ((17 - 13 + 1))) - 1) << (31 - (13) - ((17 - 13 + 1)) + 1))) |
                 ((int)(sel) << (31 - (13) - ((17 - 13 + 1)) + 1));
    } else {
        (*reg) = (*reg & ~(((1 << ((27 - 23 + 1))) - 1) << (31 - (23) - ((27 - 23 + 1)) + 1))) |
                 ((int)(sel) << (31 - (23) - ((27 - 23 + 1)) + 1));
    }
