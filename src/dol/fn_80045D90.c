...
AdxBasicDecoderExt *fn_80045D90(int max_channels, short *pcm_buffer, int pcm_size,
                                int pcm_distance) {
    ...
    decoder->fields.view_base.base.fields.view_expander.expander = fn_8004E354();
