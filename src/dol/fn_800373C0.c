...
void fn_800373C0(GXTevStageID stage, GXTevKAlphaSel sel) {
    u32 *reg;
    reg = &gx->tevKsel[stage >> 1];
    if (stage & 1) {
        (*reg) = (*reg & ~(((1 << ((12 - 8 + 1))) - 1) << (31 - (8) - ((12 - 8 + 1)) + 1))) |
                 ((int)(sel) << (31 - (8) - ((12 - 8 + 1)) + 1));
    } else {
        (*reg) = (*reg & ~(((1 << ((22 - 18 + 1))) - 1) << (31 - (18) - ((22 - 18 + 1)) + 1))) |
                 ((int)(sel) << (31 - (18) - ((22 - 18 + 1)) + 1));
    }
